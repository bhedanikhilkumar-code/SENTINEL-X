    ...
    <div className="h-full bg-[#0b0f19] border border-[rgba(0,240,255,0.18)] rounded-2xl p-3.5 shadow-cyber-glow flex flex-col justify-between font-mono text-xs select-none">
      <div className="space-y-3 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-2">
          ...
          <div className="flex items-center space-x-1 bg-slate-950 p-1 rounded-xl border border-slate-800 text-[10.5px]">
            <button
              onClick={() => setActiveTab("pgp")}
              className={`px-2.5 py-1.5 min-h-[36px] rounded-lg transition flex items-center space-x-1 touch-press ${
                activeTab === "pgp"
      ...
      <div className="pt-2 border-t border-slate-800 space-y-2">
        <button
          ...
          className="w-full py-2.5 min-h-[44px] rounded-xl bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 text-slate-950 font-black tracking-wider uppercase transition shadow-emerald-glow flex items-center justify-center space-x-2 text-xs touch-press cursor-pointer"
        >
          {downloadingPdf ? (
            <>
        ...
        {onOpenAuditChain && (
          <button
            ...
            className="w-full py-2.5 min-h-[44px] rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-cyan-400 text-[11px] font-bold flex items-center justify-center space-x-1.5 transition touch-press cursor-pointer"
          >
